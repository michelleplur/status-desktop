...
proc setFleet*(self: Service, fleet: string): bool =
  ...
  case fleetType:
    of Fleet.WakuV2Prod:
      dnsDiscoveryURL.add("enrtree://ANTL4SLG2COUILKAPE7EF2BYNL2SHSHVCHLRD5J7ZJLN5R3PRJD2Y@prod.waku.nodes.status.im")
    of Fleet.WakuV2Test:
      dnsDiscoveryURL.add("enrtree://AOFTICU2XWDULNLZGRMQS4RIZPAZEHYMV4FYHAPW563HNRAOERP7C@test.waku.nodes.status.im")
    of Fleet.StatusTest:
